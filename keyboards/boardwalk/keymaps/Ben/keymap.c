...
HYPR_T(KC_ESC),  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_F11,  KC_F12,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_LBRC,
...
SFT_T(KC_QUOT), KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    RGB_TOG, RGB_M_R, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_GRV,  KC_RSPC,
        OSL(1),   KC_PGDN, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  KC_SPC,  KC_ENT,  KC_ENT,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_MPLY
    ),
...
HYPR_T(KC_ESC),  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_NO,   KC_NO,   KC_F6,   KC_F7,   KC_F8,  KC_F9,  KC_F10,  KC_NO,
