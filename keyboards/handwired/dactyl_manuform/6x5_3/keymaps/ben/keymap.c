...
[_COLEMAK] = LAYOUT_6x5_3(
    ...
    SFT_T(KC_QUOT),     KC_Z,   KC_X,    KC_C,    KC_D,    KC_V,                                      KC_K,       KC_H,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT,
    OSL(1),             KC_LCTL,LALT_T(KC_MINS),LGUI_T(KC_GRV),KC_SPC,KC_QUOT, KC_MPLY,   KC_F12,KC_EQL,KC_ENT,     KC_LEFT,    KC_DOWN,    KC_UP,      KC_RGHT
),
...
HYPR_T(KC_ESC),  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                KC_F6,   KC_F7,   KC_F8,  KC_F9,  KC_F10,  KC_NO,
  ...
  TO(0), _______, _______, _______, KC_MINS,_______,_______,_______,_______,       KC_EQL, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT
)};
