...
[_COLEMAK] = LAYOUT(
    ...
    KC_DEL,             KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                                      KC_H,       KC_J,       KC_K,       KC_L,       KC_SCLN,       KC_BSPC,
    SFT_T(KC_PGUP),     KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,                                      KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    SFT_T(KC_PGDN),
