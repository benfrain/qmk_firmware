...
[_COLEMAK] = LAYOUT(
  ...
  MEH_T(KC_TAB),   KC_Q,   KC_W,    KC_F,    KC_P,    KC_B,                      KC_J,    KC_L,    KC_U,    KC_Y, KC_SCLN,  KC_RBRC,
  KC_DEL,   KC_A,   KC_R,    KC_S,    KC_T,    KC_G,                      KC_M,    KC_N,    KC_E,    KC_I,    KC_O,  KC_BSPC,
  SFT_T(KC_QUOT),  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MPLY,      KC_F12,KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,  SFT_T(KC_DQT),
    OSL(1),LCTL_T(KC_EQL), LALT_T(KC_MINS), LGUI_T(KC_GRV), KC_SPC,      KC_ENT,  KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
),
/* RAISE
 * ,----------------------------------------.                    ,-----------------------------------------.
